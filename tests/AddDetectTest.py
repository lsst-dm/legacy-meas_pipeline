...
class AddDetectStageTestCase(unittest.TestCase):
    ...
    def setUp(self):
        self.policy1 = policy.Policy()
        self.policy1.add("exposureKey", "calibratedExposure0")
        self.policy1.add("psfPolicy.algorithm", "DoubleGaussian")
        self.policy1.add("psfPolicy.width", 15)
        self.policy1.add("psfPolicy.height", 15)
        self.policy1.add("psfPolicy.parameter", 5.0/(2*sqrt(2*log(2))))
        self.policy1.add("detectionPolicy.minPixels", 1)
        self.policy1.add("detectionPolicy.thresholdValue", 3.0)
        self.policy1.add("detectionPolicy.thresholdType", "value")
        self.policy1.add("detectionPolicy.thresholdPolarity", "positive")
        self.policy1.add("smoothingPsfKey", "psfModel")
        self.policy1.add("positiveDetectionKey", "positiveFootprintSet")

        self.policy2 = policy.Policy()
        self.policy2.add("exposureKey", "calibratedExposure0")
        self.policy2.add("exposureKey", "calibratedExposure1")
        self.policy2.add("psfPolicy.algorithm", "DoubleGaussian")
        self.policy2.add("psfPolicy.width", 15)
        self.policy2.add("psfPolicy.height", 15)
        self.policy2.add("psfPolicy.parameter", 5.0/(2*sqrt(2*log(2))))
        self.policy2.add("detectionPolicy.minPixels", 1)
        self.policy2.add("detectionPolicy.thresholdValue", 3.0)
        self.policy2.add("detectionPolicy.thresholdType", "value")
        self.policy2.add("detectionPolicy.thresholdPolarity", "positive")
        self.policy2.add("smoothingPsfKey", "psfModel")
        self.policy2.add("positiveDetectionKey", "positiveFootprintSet")
